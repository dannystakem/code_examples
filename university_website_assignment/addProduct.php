...
<!-- Content Area for Add Product Form -->
		...
		<?php
				...
				// variables assigned form information 
				...
				// SQL statement to INSERT the new product into the product page within the database
				$sql = "INSERT INTO Products (name, description, stock, price) VALUES('$nameString', '$description', '$units', '$cost');";
				$link->query($sql);
		
				echo"<br><p>$nameString has been added to the Product Table</p>";
				...
				// creating buttons to allow the user to edit, add and delete products
