...
<!-- Content Area for PHP Table -->
			...
			// php variables for user name and password fields passed in
			$name = $_POST['userName'];
			$password = $_POST['password'];
			
			// checking that the username and password passed in are correct
			if(($name === "John Doe") && ($password === "password")){
				...
				// while loop used to print out the values of the table in the database
			...
			// catching incorrect username & password errors
